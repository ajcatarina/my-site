...
const AboutPage = () => (
  <div style={{color: 'white'}}>
    ...
    <ul style={{listStyle: 'none'}}>
      <li>Resume: <a style={{color: '#f93b8e'}} target="_blank" href="https://drive.google.com/file/d/15_1l2L_3ul6keDSsrVzi4zeaYJUlFqho/view?usp=sharin">Ariel-Jay-Catarina</a></li>
      <li>Twitter: <a style={{color: '#f93b8e'}} target="_blank" href="https://twitter.com/aj_catarina">@aj_catarina</a></li>
      <li>Github: <a style={{color: '#f93b8e'}} target="_blank" href="https://github.com/ajcatarina">ajcatarina</a></li>
      <li>Email: <a style={{color: '#f93b8e'}} target="_blank" href="mailto:ajcatarina@outlook.com">ajcatarina@outlook.com</a></li>
    </ul>
  </div>
)
